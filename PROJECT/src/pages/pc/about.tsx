...
## 0x01 短期规划  
+ 需要新增一个读书笔记/心得模块。  
  2019年上半年断断续续的读完了《你不知道的JavaScript》上中下三卷，最近一个月读了《CSS世界》，这周又读了《数据结构与算法Javascript描述》很多技术细节需要总结。  
## 0x10 长期规划  
+ 重构本站。  
  目前项目框架由脚手架Umi/Dva生成，随着本职工作和对Web理解的深入，没有必要继续依赖比较通用的框架。  
## 0x11 个人简介  
+ 1996年出生，生活在北京最西部，2014年高考后首次离开家乡。  
+ 2014年就读北京工业大学的计算机科学与技术专业，2018年毕业。  
+ 2018年正式参加工作，所在行业属于互联网、房产、消费金融三个领域，从事Web前端开发工作，至今已满一年。  
`}
    escapeHtml={false}
  />;
};
